...
public class GameController {
    ...
    public ResponseEntity<?> findGameDetails(@PathVariable Long gameSeq) {
        ...
        try{
            ...
            GameDetailDto dummy = new GameDetailDto(gameSeq, gameSeq.toString()+"번 게임", "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2073&q=80",
