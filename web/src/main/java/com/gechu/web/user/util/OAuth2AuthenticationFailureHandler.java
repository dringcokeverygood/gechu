package com.gechu.web.user.util;
...
import static com.gechu.web.user.repository.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
